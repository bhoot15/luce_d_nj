            ...
            <div class="row v-align-children">
                ...
                <div class="col-md-6 col-md-offset-1 col-sm-5 col-sm-offset-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="mb32">
                                <img class="cast-shadow" alt="Screenshot" src="img/njs/OVERSIZED FRAMES WITH CASUAL KURTI.jpg"/>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="mb32">
                                <img class="cast-shadow" alt="Screenshot" src="img/njs/NOTHING WRONG ON BEING PURE DESI.jpg"/>
                            </div>
                        </div>
                    </div>
                    <!--end of row-->
    ...
    <div class="container">
        <div class="row mb64 mb-xs-24">
            <div class="col-md-8 col-md-offset-2 text-center">
                <a href="#">
                    <h2 class="uppercase  mb16 bold">Signature Collection</h2>
                </a>
