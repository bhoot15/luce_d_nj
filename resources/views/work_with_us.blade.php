        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-5">
                    ...
                    <hr>
                    @foreach($wwus as $ww)
                        {{--We’re always on the lookout for creative people and fashion enthusiasts to join our team.
                        Whether you’re
                        a recent graduate, studying or just share a huge passion in fashion and lifestyle, we’d love to
                        hear
                        from you.--}}
                        {{$ww->content}}
                        <br><br>

                        <h5><b>Write to us at: </b> <u>{{$ww->email}}</u></h5>
                        <!--                <h4 class="uppercase">Get expert insights straight to your e-mail</h4>-->
                        <h4 class="bold">{{$ww->message}}</h4>
                    @endforeach
                </div>
